...
import ken_header_black from "@/public/ken-header-black.svg";
import ken_header_white from "@/public/ken-header-white.svg";
...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-between md:space-x-10 lg:space-x-12 xl:space-x-16 md:flex items-center place-items-center md:justify-center py-2 md:px-10 px-8">
        <div className="select-none order-2 md:order-1 cursor-pointer flex items-center text-gray-800">
          <Link href={"/"} className="">
            {currentTheme === "dark" ? (
              <Image src={ken_header_white} alt="header" width="100" />
            ) : (
              <Image src={ken_header_black} alt="header" width="100" />
            )}
          </Link>
        </div>
        {currentTheme === "dark" ? (
        ...
        <ul
          ...
          } bg-white py-2 md:py-0 md:bg-inherit font-semibold order-4 md:flex md:items-center md:pb-0 pb-4 absolute md:static bg-light-blue md:bg-none md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 lg:transition-none transition-all duration-500 ease-in ${
